        ...
        <div className="add-container">
          <table className="add-table">
            ...
            {students.map((student, index) => (
              <TableList key={student._id} index={index+1} firstName={student.firstName} lastName={student.lastName} SID={student.SID} objID={student._id} selected={props.selected}/>
            ))}
          </table>
        </div>
      </div>
